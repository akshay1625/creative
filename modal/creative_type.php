<?php
include('include/creative_type.php');
?>
  ...
  <div class=" p-3" style="height: 100vh !important; width: 100%; " >
      <div class="row">
        <div class="col-md-6 "  >
          <div class="card">
            <div class="card-body">
              <h5 class="text-dark"><strong>Creative Type Master </strong></h5>
              <form  method="post" id="roleForm" role="form" enctype="multipart/form-data" style="border-top: 1px solid #cfcfcf;" >
              <div class="card-body p-1 mt-2">
                  <div class="form-group">
                    <label for="creative_type" class="text-dark-50 "> Title</label>
                    <input type="text" class="form-control" id="creative_type" value="<?php echo $creative_type ;?>" placeholder="Enter Project Type. . . . ." name="creative_type">
                    <h6  class="creative_typeerr text-danger " id="err"><?php echo $creative_typeerr ; ?></h6>
                  </div>
                  <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
            <?php
              $x= mysqli_num_rows(mysqli_query($sql,"SELECT * from `awt_creative_type` where deleted = 0"));
              ?>
