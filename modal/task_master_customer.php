<?php
include('include/task_master_customer.php');
?>
              ...
              <table width="100%" class="table table-striped table-bordered table-sm" id="myTable">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th class="text-left" style="width:15% ;">Task </th>
                    <!-- <th class="text-left" style="width:20% ;">Creative Type </th> -->
                    <th class="text-left" style="width:10% ;">Start Date </th>
                    <th class="text-left" style="width:15% ;">View Sample</th>
                    <th class="text-left" style="width:15% ;">Status</th>
                  </tr>
                </thead>
                <tbody id="roleTableBody">
                  <!-- Sample Data -->
                   <?php getrow($sql , $project_id)?>
                </tbody>
              </table>
            </div>
          </div>
