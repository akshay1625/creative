                            ...
                            <div class="card-body p-1 mt-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="position:relative;">
                                        ...
                                        <input class="form-control" type="file" name="file" id="breadcrumbImage">
                                        <?php
                                        if ($filepath != '') {
                                ...
                                <div class="form-group row mr-1 justify-content-end">
                                    ...
                                    <button type="submit" name="submit" class="btn col-1 btn-primary btn-sm btn-block">Submit</button>
                                </div>
